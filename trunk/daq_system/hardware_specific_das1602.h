...
/**
   ...
   this file is already set up for a ComputerBoards DAS 1602 board.
...
#ifndef _HWSPEC_DAS1602_H
#define _HWSPEC_DAS1602_H

#define SCAN_UNITS 65536       //1602's scanning resolution (16bit) 
#define NUM_AD_CHANNELS 16      //number of analog input channels
#define NUM_GAIN_PARAMETERS 8 // the number of gain settings this device has
