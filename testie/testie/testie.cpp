...
TestieApp::TestieApp()
{
  setCaption(tr("Testie " VERSION ) );

  printer = new QPrinter;
  untitledCount=0;
  pDocList = new QList<TestieDoc>();
...
void TestieApp::createClient(TestieDoc* doc)
{
  TestieView* w = new TestieView(doc, pWorkspace,0,WDestructiveClose);
...
void TestieApp::openDocumentFile(const char* file)
{
...
bool TestieApp::eventFilter(QObject* object, QEvent* event)
{
  if((event->type() == QEvent::Close)&&((TestieApp*)object!=this))
  {
    QCloseEvent* e=(QCloseEvent*)event;
    TestieView* pView=(TestieView*)object;
    TestieDoc* pDoc=pView->getDocument();
...
void TestieApp::slotFileSave()
{
  statusBar()->message(tr("Saving file..."));
	
  TestieView* m = (TestieView*)pWorkspace->activeWindow();
  if( m )
  {
    TestieDoc* doc = m->getDocument();
...
void TestieApp::slotViewToolBar(bool toggle)
{
...
void TestieApp::slotViewStatusBar(bool toggle)
{
...
void TestieApp::slotWindowNewWindow()
{
...
void TestieApp::slotHelpAbout()
{
  QMessageBox::about(this,tr("About..."),
                     tr("Testie\nVersion " VERSION
                     "\n(c) 2001 by Calin Culianu"));
}

void TestieApp::slotStatusHelpMsg(const QString &text)
{
  ///////////////////////////////////////////////////////////////////
...
void TestieApp::windowMenuAboutToShow()
{
  pWindowMenu->clear();	
...
void TestieApp::windowMenuActivated( int id )
{
